...
words = []
documents = []
intents = json.loads(open('ChatbotKeras/intents.json').read())
...
pickle.dump(words, open('ChatbotKeras/words.pkl', 'wb'))
pickle.dump(classes, open('ChatbotKeras/classes.pkl', 'wb'))
...
model.save('ChatbotKeras/model.h5', m)
